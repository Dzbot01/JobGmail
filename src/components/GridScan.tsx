...
function centroid(points: faceapi.Point[]) {
  ...
  for (const p of points) {
    x += (p as any)._x || (p as any).x;
    y += (p as any)._y || (p as any).y;
  }
  return { x: x / n, y: y / n };
}

function dist2(a: faceapi.Point, b: faceapi.Point) {
  const ax = (a as any)._x || (a as any).x;
  const ay = (a as any)._y || (a as any).y;
  const bx = (b as any)._x || (b as any).x;
  const by = (b as any)._y || (b as any).y;
